package com.example.beerrunserver.Common;
...
import com.example.beerrunserver.HomeActivity;
...
public class Common {
    ...
    public static Observable<CartItem> getBitmapFromUrl(Context context, CartItem cartItem, Document document) {
        return Observable.fromCallable(()->{
            try {
                Bitmap bitmap = Glide.with(context).asBitmap().load(cartItem.getFoodImage())
                        .submit()
                        .get();
