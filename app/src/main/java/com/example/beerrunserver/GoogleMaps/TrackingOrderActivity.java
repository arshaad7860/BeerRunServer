package com.example.beerrunserver.GoogleMaps;
...
import com.example.beerrunserver.Callback.ISingleShippingOrderCallbackListener;
...
import com.example.beerrunserver.Remote.IGoogleAPI;
import com.example.beerrunserver.Remote.RetrofitGoogleAPIClient;
...
public class TrackingOrderActivity extends FragmentActivity implements OnMapReadyCallback, ISingleShippingOrderCallbackListener, ValueEventListener {
    ...
    private void initViews() {
        ...
        iGoogleAPI= RetrofitGoogleAPIClient.getInstance()
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        try {
            ...
            if (!success)
                Log.e("BeerRunServer", "Style parsing failed");
        } catch (Resources.NotFoundException ex) {
            Log.e("BeerRunServer", "Resource not found");
        }
